 ...
 */ 
 ...
 import programmingtheiot.gda.system.SystemPerformanceManager; // Import the class
 ...
 public class GatewayDeviceApp
 {
	 ...
	 // private var's
	 private SystemPerformanceManager sysPerfMgr = null; // Declare the instance variable
	 ...
	 public GatewayDeviceApp(String[] args)
	 {
		 ...
		 parseArgs(args);
		 this.sysPerfMgr = new SystemPerformanceManager(); // Initialize the instance
	 }
